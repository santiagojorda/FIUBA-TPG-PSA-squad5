...
def eliminar_ticket(context):
    context.response = context.client.delete(f"{ENDPOINT_TICKETS}/{context.expected_ticket.product_id}/{context.expected_ticket.version_code}/{context.expected_ticket.id}")
